...
dotenv.config({path: './config/config.env'});//<-example (Path that connects to your own config)
const Bootcamp = require("./models/bootcampDataModel")//<-example (insert your own data model)
//Outside================================
seeder(process.env.MONGO_URI, `${__dirname}/_data/bootcamps.json`, "i", Bootcamp)
/**
